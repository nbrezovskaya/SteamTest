...
public final class Logger {
	...
	private static PropertiesResourceManager localManager;
	static {
		String locale;
		if (Strings.isNullOrEmpty(props.getProperty(AQA_LOCALE))) {
			locale = System.getProperty(AQA_LOCALE, DEF_LOCALE.toString()).toLowerCase();
		} else {
			locale = props.getProperty(AQA_LOCALE).toLowerCase();
		}
		localManager = new PropertiesResourceManager(String.format("localization/loc_%1$s.properties", locale));
	}
	 ...
	 */
	public void step(final double step) {
